...
public class PersistentClient extends Activity {
    ...
    public class NetworkTask extends AsyncTask<Void, byte[], Boolean> {
        ...
        protected Boolean doInBackground(Void... params) { //This runs on a different thread
            ...
            try {
                ...
                SocketAddress sockaddr = new InetSocketAddress("54.243.248.135", 14000);
                nsocket = new Socket();
                nsocket.connect(sockaddr, 14000); //10 second connection timeout
